...
TEST_IMG_GT_FILE_DIR=/home/nas01/grp_IMRECOG/wangfei11/data_66/AI_Zhedang/Test_IMGS
TEST_IMG_GT_FILE_PATH=/home/nas01/grp_IMRECOG/wangfei11/data_66/AI_Zhedang/Test_IMGS/imListTest_gt_${LABEL_NUM}.txt
...
do
    ...
    do
        ...
        then
            ...
            CUDA_VISIBLE_DEVICES=""  python /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/export_inception_model_xiaomi.py \
            ...
            echo "---------------------gpu: " ${gpu}
            CUDA_VISIBLE_DEVICES="${gpu}"   python -u /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/compute_scores.py \
                --pb_path=${pb_path} \
            ...
            python -u /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/getThreshold_wide_mul_thread.py ${score_file} \
                ${TEST_IMG_GT_FILE_PATH}  ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt
            
            python -u /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/Eval_scene_central_control/getCrossMatrix.py ${score_file} \
                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt

#            python -u /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/Eval_scene_central_control/getCrossMatrix.py ${score_file} \
#                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt \
#                /home/nas01/grp_IMRECOG/wangfei11/data_66/AI_Zhedang/label_map.txt
        else
