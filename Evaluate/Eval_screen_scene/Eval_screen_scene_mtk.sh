...
TEST_IMG_GT_FILE_DIR=/home/nas01/grp_IMRECOG/wangfei11/data_66/screen_scene/Test_IMGS/
...
do
    ...
    do
        ...
        then
            ...
            python -u /home/nas01/grp_IMRECOG/wangfei11/Code/slim_scene/Evaluate/getCrossMatrix.py ${score_file} \
                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt
        else
