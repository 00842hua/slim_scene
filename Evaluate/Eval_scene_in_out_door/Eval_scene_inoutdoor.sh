...
TEST_IMG_GT_FILE_DIR=/home/work/wangfei11/data/video_labeling/Indoor_Outdoor_Test_IMGS
...
label_file=/home/work/wangfei11/data/video_labeling/labels_inoutdoor_3_name.txt
...
#            python -u /home/work/wangfei11/slim_scene/Evaluate/Eval_scene_1k/getThreshold_wide_mul_thread.py ${score_file} \
#                ${TEST_IMG_GT_FILE_PATH}  ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt 20
...
#                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt
            ...
            rp_file=${dir}/result_rp_${one_ckpt_step}.txt
            python -u /home/work/wangfei11/slim_scene/Evaluate/Eval_scene_in_out_door/calc_recall_precision.py ${TEST_IMG_GT_FILE_PATH} ${score_file} ${label_file} > ${rp_file} 2>&1
            
            #rm ${score_file} badcases_${score_file}
