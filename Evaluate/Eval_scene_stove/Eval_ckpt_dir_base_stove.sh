...
# /home/work/wangfei11/slim_scene/Evaluate/Eval_scene_stove/Eval_ckpt_dir_base_stove.sh mobilenet_v1_qc MobilenetV1/Predictions . scene 224 5 `pwd`
...
LABEL_FILE_PATH=/home/work/wangfei11/data/AI_Stove/label_${LABEL_NUM}.txt
TEST_IMG_GT_FILE_PATH=/home/work/wangfei11/data/AI_Stove/Test_IMGS/imListTest_gt_${LABEL_NUM}.txt
    ...
    do
        ...
        then
            ...
            python -u /home/work/wangfei11/slim_scene/Evaluate/getThreshold_wide_mul_thread.py ${score_file} \
                ${TEST_IMG_GT_FILE_PATH}  ${LABEL_NUM} ${LABEL_FILE_PATH}
            
            python -u /home/work/wangfei11/slim_scene/Evaluate/Eval_scene_central_control/getCrossMatrix.py ${score_file} \
                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${LABEL_FILE_PATH}
        else
