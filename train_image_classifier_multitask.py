...
tf.app.flags.DEFINE_integer(
    'label_count_task1', 208, 'Label count')

tf.app.flags.DEFINE_integer(
    'label_count_task2', None, 'Label count')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        dataset = dataset_factory.get_dataset(
            ...
            train_image_count=FLAGS.train_image_count, label_count=FLAGS.label_count_task2,
            file_pattern=FLAGS.tf_file_pattern)
        tf.logging.info("************************** tf_file_pattern:     %s", FLAGS.tf_file_pattern)
        tf.logging.info("************************** label_count_task1:         %s", FLAGS.label_count_task1)
        tf.logging.info("************************** label_count_task2:         %s", FLAGS.label_count_task2)
        ...
        network_fn = nets_factory.get_network_fn(
            FLAGS.model_name,
            num_classes=FLAGS.label_count_task1,
            num_classes_task2=dataset.num_classes,
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            image = image_preprocessing_fn(image, train_image_size, train_image_size, label=label,
                                           special_labels_list=[], crop_area_min=FLAGS.crop_area_min)
        ...
        def clone_fn(batch_queue):
            ...
            logits = end_points['Logits_task2']  # change logits to task2
        ...
        update_ops = tf.get_collection(tf.GraphKeys.UPDATE_OPS, first_clone_scope)  # TODO donot update batch_norm
