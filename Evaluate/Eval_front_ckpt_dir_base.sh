...
TEST_IMG_GT_FILE_DIR=/home/work/wangfei11/data/AI_scene_front/Test_IMGS
...
do
    ...
    do
        ...
        then
            ...
            gpu=`nvidia-smi  | grep Default | awk '{print NR-1"\t"$11-$9-5000}' | grep -v '-' | sort -k2 -nr | head -n1 | awk '{print $1}'`
            while [ ! ${gpu} ]
            do
