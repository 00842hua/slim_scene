...
TEST_IMG_GT_FILE_DIR=/home/work/wangfei11/data/AI_scene_1k/Test_IMGS
...
label_file=/home/work/wangfei11/data/AI_scene_1k/labels_${LABEL_NUM}.txt
...
#                ${TEST_IMG_GT_FILE_PATH} ${LABEL_NUM} ${TEST_IMG_GT_FILE_DIR}/../label_${LABEL_NUM}.txt
            ...
            python -u /home/work/wangfei11/slim_scene/Evaluate/Eval_scene_1k/calc_recall_precision.py ${TEST_IMG_GT_FILE_PATH} ${score_file} ${label_file} > ${rp_file} 2>&1
