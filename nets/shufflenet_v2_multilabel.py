...
def shufflenet_v2_unit(inputs,
    ...
    with tf.variable_scope(scope, 'bottleneck', [inputs]) as sc:
        ...
        # channel shuflle
        output = channel_shuffle(output, num_groups=groups, scope='channel_shuffle')
...
def shufflenet_v2(inputs,
    ...
    blocks =  [
        shufflenet_v2_block('Stage2', depth=depths[0], num_units=4, stride=2, groups=2, left_ratio=0.5),
        shufflenet_v2_block('Stage3', depth=depths[1], num_units=8, stride=2, groups=2, left_ratio=0.5),
        shufflenet_v2_block('Stage4', depth=depths[2], num_units=4, stride=2, groups=2, left_ratio=0.5),
    ]
...
shufflenet_v2_d05 = wrapped_partial(shufflenet_v2, depth_multiplier=0.5)
shufflenet_v2_d10 = wrapped_partial(shufflenet_v2, depth_multiplier=1.0)
shufflenet_v2_d15 = wrapped_partial(shufflenet_v2, depth_multiplier=1.5)
shufflenet_v2_d20 = wrapped_partial(shufflenet_v2, depth_multiplier=2.0)
